...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-20 border-2 border-rose-800">
      
    <div className="mb-6 grid text-center lg:max-w-7xl lg:w-full lg:mt-10 lg:grid-cols-3 lg:text-left md:mt-10 sm:mt-10 border-2 border-rose-800">
